...
module OpenFoodNetwork
  class ScopeVariantsForSearch
    ...
    def scope_to_distributor
      params[:available_for_subscriptions] ? scope_to_available_for_subscriptions_in_distributor : scope_to_available_for_orders_in_distributor
    end
    ...
    def scope_to_available_for_subscriptions_in_distributor
      @variants = @variants.merge(OpenFoodNetwork::SubscriptionService.new(distributor).available_variants)
      scope_variants_to_distributor(@variants, distributor)
    end
